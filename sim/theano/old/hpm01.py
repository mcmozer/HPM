...
def build_model(tparams, options):
    ...
    tgt_prob, updates = theano.scan(cost_fn,
...
def pred_error(f_pred, f_cost, prepare_data, data, iterator, options, verbose=False):
    """
...
def train_model(
    ...
    train_err, train_cost = pred_error(f_pred,f_cost,prepare_data,
                                            train,kf_train_sorted,model_options)
    valid_err, valid_cost = pred_error(f_pred,f_cost,prepare_data, 
                                                   valid,kf_valid,model_options)
    test_err, test_cost  = pred_error(f_pred,f_cost,prepare_data, 
